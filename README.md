...
NOTE: if you have aDNA targets, we reccomend using --samedosage instead of --zerodsoage. In our experiments, we have found improved performance of MetaGLIMPSE.
